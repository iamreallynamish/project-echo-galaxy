    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 pt-32 pb-24 px-6 md:px-10">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            <span className={`inline-block text-sm text-muted-foreground font-medium tracking-wider mb-4 opacity-0 ${loaded ? 'animate-slide-down' : ''}`}>
              PROJECTS
            </span>
            ...
            <p className={`mt-4 text-lg text-muted-foreground max-w-2xl opacity-0 ${loaded ? 'animate-slide-down' : ''}`} style={{ animationDelay: '0.2s' }}>
              A collection of selected projects showcasing my approach to design challenges across various mediums and contexts.
            </p>
          </div>
          
          {/* Category Filter */}
          <div className={`mb-12 border-b border-border/50 pb-4 overflow-x-auto opacity-0 ${loaded ? 'animate-slide-down' : ''}`} style={{ animationDelay: '0.3s' }}>
